...
var NombreElementDansMonTableau = Prenoms.length;
...
//-- Pour i = 0 (Au départ i vaut 0); tant que i est strictement inférieur a "NombreElementDansMonTableau" (Prenoms.length); alors i++ (Incrémentation par pas de i)
for(let i = 0; i< NombreElementDansMonTableau ; i++) {
