...
|   
|  L'Opérateur de comparaison " ==" signifie que égal . il permet de vérifier que 2 variables sont identiques.
|  
|  L'Opérateur de comparaison " ===" signifie : strictelent égale a :  il va comparer la valeur, mais aussi le type ! 
|
|  L'Opérateur de comparaison " != " signifie : Différent de. 
|  'Opérateur de comparaison " !== " signifie :  strictement Différent de. 
|
|------------------------------------------------------------------------------------------------------------------------*/
